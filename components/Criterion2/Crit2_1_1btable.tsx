...
const row1 = [{id:1,item:'Number of Students Sanctioned'},{id:2,item:2075},{id:3,item:1992},{id:4,item:1916},{id:5,item:779},{id:6,item:757}]
const Crit2_1_1btable = () => {
    return (
...
export default Crit2_1_1btable